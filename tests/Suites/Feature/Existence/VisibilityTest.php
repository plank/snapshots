...
describe('The visiblity accurately reflects all snapshots where content is visible', function () {
    /**
    ...
    it('shows the correct visibility for each snapshot', function () {
        snapshots()->setActive(snapshot('1.0.0'));
